        ...
        <div className="flex flex-col gap-2">
          {INTRO_DATA.map((intro, index) => (
            ...
            >
              ...
              <Image
                src={`/illustrations/${intro.illustration}.svg`}
                alt={intro.title}
                width={113}
                height={113}
                priority
        ...
        <div className="mx-auto flex max-w-2xl flex-col justify-center gap-4 text-center md:gap-8 md:text-start lg:mx-0 lg:max-w-[472px]">
          ...
          <div className="flex flex-col gap-4">
            <p className="text-base tracking-tight md:text-lg lg:text-xl">
              Bitcoin can be a lot of “hash this”, “node that”. It’s like it has
              its own language. It’s almost normal to feel lost or even a little
              stressed trying to keep up. BitTerms is making bitcoin terms be
              regular words. We take those complicated Bitcoin terms and
              translate them into everyday conversation. No stress. Just learn
              at your own pace.
            </p>
          </div>
